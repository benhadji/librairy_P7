 ...
 * 
 */
@WebServiceClient(name = "Reservation", targetNamespace = "http://services.service.WebService.org/", wsdlLocation = "http://lfr023221:50396/library-service8582743662546225902/Reservation?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATION_QNAME = new QName("http://services.service.WebService.org/", "Reservation");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lfr023221:50396/library-service8582743662546225902/Reservation?wsdl");
    ...
    public ReservationService getReservationServicePort() {
        return super.getPort(new QName("http://services.service.WebService.org/", "ReservationServicePort"), ReservationService.class);
    }
    ...
    public ReservationService getReservationServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.service.WebService.org/", "ReservationServicePort"), ReservationService.class, features);
    }
