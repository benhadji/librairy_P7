 ...
 * 
 */
@WebServiceClient(name = "Editor", targetNamespace = "http://services.service.WebService.org/", wsdlLocation = "http://lfr023221:50396/library-service8582743662546225902/Editor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EDITOR_QNAME = new QName("http://services.service.WebService.org/", "Editor");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lfr023221:50396/library-service8582743662546225902/Editor?wsdl");
    ...
    public EditorService getEditorServicePort() {
        return super.getPort(new QName("http://services.service.WebService.org/", "EditorServicePort"), EditorService.class);
    }
    ...
    public EditorService getEditorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.service.WebService.org/", "EditorServicePort"), EditorService.class, features);
    }
