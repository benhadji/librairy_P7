 ...
 * 
 */
@WebServiceClient(name = "Author", targetNamespace = "http://services.service.WebService.org/", wsdlLocation = "http://lfr023221:8080/library-service46650661518080117553/Author?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTHOR_QNAME = new QName("http://services.service.WebService.org/", "Author");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lfr023221:8080/library-service46650661518080117553/Author?wsdl");
    ...
    public AuthorService getAuthorServicePort() {
        return super.getPort(new QName("http://services.service.WebService.org/", "AuthorServicePort"), AuthorService.class);
    }
    ...
    public AuthorService getAuthorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.service.WebService.org/", "AuthorServicePort"), AuthorService.class, features);
    }
